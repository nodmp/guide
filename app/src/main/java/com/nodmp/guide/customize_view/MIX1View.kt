...
class MIX1View(context: Context?, attrs: AttributeSet?) : View(context, attrs) {
    ...
    ///////////////////////SRC/////////////////////////////////////////////
    val shader: Shader = ComposeShader(bitmapShader1, bitmapShader2, PorterDuff.Mode.SRC_OVER)
...
//        camera.setLocation(0f, 0f, -6 * resources.displayMetrics.density)
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.drawText("SRC_OVER", 60f, 60f, textPaint)
